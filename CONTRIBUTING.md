...
> [GPG key](https://keys.openpgp.org/search?q=hourrad.f%40gmail.com)
...
<!-- TODO create an issue template for bugs and errors that can be used as a guide and that defines the structure of the information to be included. If you do so, reference it here in the description. -->
...
<!-- TODO create an issue template for enhancement suggestions that can be used as a guide and that defines the structure of the information to be included. If you do so, reference it here in the description. -->


## Styleguides
- Your code must follow the [k&r style](https://en.wikipedia.org/wiki/Indentation_style#K&R_style)
